...
--
-- Host: localhost
-- Generation Time: Oct 02, 2025 at 02:37 PM
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `fk_orders_store` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ALGORITHM = INPLACE,
  LOCK = NONE;
...
ALTER TABLE `staffs`
  ...
  ADD CONSTRAINT `fk_staffs_store` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ALGORITHM = INPLACE,
  LOCK = NONE;
...
--
ALTER TABLE `stocks`
  ADD CONSTRAINT `fk_stocks_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_stocks_store` FOREIGN KEY (`store_id`) REFERENCES `stores` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ALGORITHM = INPLACE,
  LOCK = NONE;
