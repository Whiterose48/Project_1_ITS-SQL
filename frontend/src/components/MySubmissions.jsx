  ...
  if (!submissions || submissions.length === 0) {
    return (
      <div className="bg-white rounded-xl border-[3px] border-slate-800 shadow-[8px_8px_0px_0px_#1e293b] p-10 flex flex-col items-center justify-center min-h-[300px]">
        ...
        <p className="text-slate-500 text-center text-lg font-black uppercase tracking-widest">
          No submissions yet.
        </p>
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className={`rounded-xl p-8 border-[3px] border-slate-900 shadow-[8px_8px_0px_0px_#0f172a] relative overflow-hidden ${
        ...
        <div className="relative flex items-center justify-between z-10">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-4xl font-black text-white uppercase tracking-tighter drop-shadow-[3px_3px_0px_#000]">
                {isPassed ? 'QUERY PASSED!' : 'QUERY FAILED'}
              </h3>
            </div>
          </div>
          
          <div className={`hidden lg:flex px-6 py-3 font-black text-xl uppercase tracking-widest border-[3px] border-slate-900 shadow-[4px_4px_0px_0px_#0f172a] rotate-[3deg] ${
      ...
      <div>
        ...
        <div className="bg-[#0f172a] p-6 rounded-xl border-[3px] border-slate-800 shadow-[6px_6px_0px_0px_#1e293b] relative">
          ...
          <pre className="font-mono text-emerald-400 text-[15px] leading-relaxed whitespace-pre-wrap mt-2">{latestSubmission.code}</pre>
        </div>
      </div>
